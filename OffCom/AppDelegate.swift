...
//  OffCom
//
//  Created by Dino Budimilic on 04/11/2016.
//  Copyright © 2016 Dino Budimilic. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
    ...
    appNav = UINavigationController(rootViewController: MainTVC())
...
extension UIViewController {
  var navBarOffset: CGFloat {
    return sharedApp.statusBarFrame.size.height +
